...
#ifndef __ISPC_STRUCT_ZnccHalf__
#define __ISPC_STRUCT_ZnccHalf__
struct ZnccHalf {
    struct Image lumdev;
    struct Image mean;
    struct Image rcpsd;
...
#ifndef __ISPC_STRUCT_ZnccMatchingSizes__
#define __ISPC_STRUCT_ZnccMatchingSizes__
...
extern "C" {
    ...
    extern void ZnccHalf_Delete(struct ZnccHalf &znccHalf);
    extern enum ZnccError ZnccHalf_SetImage(struct ZnccHalf &znccHalf, const struct Image &image, const struct ZnccMatchingSizes &sizes, const struct SpecialImages &si);
    extern void ZnccMatchingSizes_Update(struct ZnccMatchingSizes &sizes);
#if defined(__cplusplus) && (! defined(__ISPC_NO_EXTERN_C) || !__ISPC_NO_EXTERN_C )
} /* end extern C */
#endif // __cplusplus
